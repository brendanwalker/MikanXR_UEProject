...
#include "MikanXREditorWidget.generated.h"
...
UCLASS()
class MIKANXREDITOR_API UMikanXREditorWidget : public UEditorUtilityWidget
{
	GENERATED_BODY()
...
public:
	...
	/**
	 * Callbacks to be binded to the MikanXREditor methods.
	 */
