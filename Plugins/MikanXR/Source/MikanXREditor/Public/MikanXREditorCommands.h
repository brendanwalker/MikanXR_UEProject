...
class MIKANXREDITOR_API FMikanXREditorCommands : public TCommands<FMikanXREditorCommands>
{

public:

	FMikanXREditorCommands();
	void RegisterCommands() override;
	TSharedPtr<FUICommandInfo> OpenMikanXRWindow;
};
